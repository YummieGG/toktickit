...
| API-10 | API | FR-10, BR-13, BR-14, BR-19, BR-20, AC-09 | Owner assignment, IT Priority, and status workflow | Only permitted Staff mutations succeed; owner eligibility, priority separation, confirmations, transitions, and concurrent conflict are enforced | `server/tests/lab-03/staff-ticket-detail.api.test.ts` | Focused pass (2026-09-14) |
