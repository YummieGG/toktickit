...
## LLM Used
- **Google Gemini (Antigravity Agent)** — Gemini 3.1 Pro High
...
The AI followed instructions accurately and covered all requested requirements, with only minor human refinement needed to polish the structure and align closely with the lab guidelines.